...
class StockWarehouse(models.Model):
    ...
    def _update_name_and_code(self, new_name=False, new_code=False):
        ...
        for warehouse in self:
            if warehouse.manufacture_pull_id and new_name:
                warehouse.manufacture_pull_id.write({'name': warehouse.manufacture_pull_id.name.replace(warehouse.name, new_name, 1)})
        return res
